        ...
        <div class='grats-options'>
            <div class='ready-options'>
                ...
                <div id='sloganSelect' :style='showDropdown ? "display:block" : "display:none"'>
                    ...
                    <p class='option' @click='selectPozd(5)' :data-checked='optionValue == "5" ? "true" : "false"' data-value='5'>Поздравляю с праздником весны! Пусть мир дарит красоту и вдохновение, а близкие люди – любовь и счастье.</p>
